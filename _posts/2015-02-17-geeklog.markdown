...
- [-](#-)
    - [DONE Diigo 가입하고, 북마크 정리함](#done-diigo-가입하고-북마크-정리함)
    - [DONE Lightweight Jekyll Theme - Contrast 적용](#done-lightweight-jekyll-theme---contrast-적용)
    - [DONE redcarpet으로 markdown 프로세싱 엔진 변경](#done-redcarpet으로-markdown-프로세싱-엔진-변경)
    - [DONE Jekyll comment 달기 (Disqus)](#done-jekyll-comment-달기-disqus)
    - [DONE Jekyll Pagination 적용하기](#done-jekyll-pagination-적용하기)
    - [Emacs support for Jekyll blogs](#emacs-support-for-jekyll-blogs)
    - [org2jekyll - org mode를 지원하는 Jekyll minor mode in Emacs](#org2jekyll---org-mode를-지원하는-jekyll-minor-mode-in-emacs)
    - [DONE Emacs로 man page보기](#done-emacs로-man-page보기)
    - [DONE Emacs markdown-toc 기능을 이용해서 목차를 만듬](#done-emacs-markdown-toc-기능을-이용해서-목차를-만듬)
    - [DONE Emacs dired에서 그림을 바로 보여준다.](#done-emacs-dired에서-그림을-바로-보여준다)
    - [Jekyll bootstrap 테스트](#jekyll-bootstrap-테스트)
    - [DONE man page만들어봄](#done-man-page만들어봄)
    - [DONE jekyll test하기](#done-jekyll-test하기)
    - [DONE Emacs + magit으로 Git 조작하기](#done-emacs--magit으로-git-조작하기)
    - [DONE jekyll test하기](#done-jekyll-test하기)
    - [DONE Markdown으로 code listing을 나타내기](#done-markdown으로-code-listing을-나타내기)
    - [Coding할 땐 Tmux+Vim, Management는 Emacs에서 org-mode](#coding할-땐-tmuxvim-management는-emacs에서-org-mode)
    - [Emacs기반 markdown 에디터](#emacs기반-markdown-에디터)
    - [http://dillinger.io/ Web기반 markdown에디터](#httpdillingerio-web기반-markdown에디터)
    - [DONE Emacs에서 IRC를 해보다.](#done-emacs에서-irc를-해보다)
    - [Emacs deft.el](#emacs-deftel)
    - [Github에 web page만들다.](#github에-web-page만들다)
    - [org mode로 calendar와 연동해서 보다.](#org-mode로-calendar와-연동해서-보다)
    - [DONE Emacs와 Cscope를 연동하다.](#done-emacs와-cscope를-연동하다)
    - [VIM vundle와 pathogon](#vim-vundle와-pathogon)
    - [DONE Emacs에서 batch mode로 org-mode를 HTML로 export하기](#done-emacs에서-batch-mode로-org-mode를-html로-export하기)
    - [DONE Emacs list in 15min 따라해봄](#done-emacs-list-in-15min-따라해봄)
    - [DONE info 뷰어로 Emacs 이용하기](#done-info-뷰어로-emacs-이용하기)
    - [vim script Hello World 해보기](#vim-script-hello-world-해보기)
