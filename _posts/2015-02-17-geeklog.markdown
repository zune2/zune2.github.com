...
- [-](#-)
    - [해볼 일 summary](#--summary)
        - [redcarpet으로 markdown 프로세싱 엔진 변경](#redcarpet-markdown---)
        - [Jekyll comment 달기 (Disqus)](#jekyll-comment--disqus)
        - [Jekyll Pagination 적용하기](#jekyll-pagination-)
        ...
        - [Emacs로 man page보기](#emacs-man-page)
        - [Emacs markdown-toc 기능을 이용해서 목차를 만듬](#emacs-markdown-toc----)
        - [Emacs dired에서 그림을 바로 보여준다.](#emacs-dired---)
        - [Jekyll bootstrap 테스트](#jekyll-bootstrap-)
        - [man page만들어봄](#man-page)
        - [org-mode에 plantuml을 이용해서 UML 다이어그램 그리기](#org-mode-plantuml--uml--)
        - [jekyll test하기](#jekyll-test)
        - [Emacs + magit으로 Git 조작하기](#emacs--magit-git-)
        - [jekyll test하기](#jekyll-test)
        - [Markdown으로 code listing을 나타내기](#markdown-code-listing-)
        ...
        - [Emacs에서 IRC를 해보다.](#emacs-irc-)
        - [Emacs deft.el](#emacs-deftel)
        - [Github에 web page만들다.](#github-web-page)
        - [org mode로 calendar와 연동해서 보다.](#org-mode-calendar--)
        - [org-agenda-todo를 키맵하다.](#org-agenda-todo-)
        - [Emacs와 Cscope를 연동하다.](#emacs-cscope-)
        - [VIM vundle와 pathogon](#vim-vundle-pathogon)
        - [org-mode ARCHIVE tag이용하기](#org-mode-archive-tag)
        - [org-mode에서 snippets 사용하기](#org-mode-snippets-)
        - [Emacs에서 batch mode로 org-mode를 HTML로 export하기](#emacs-batch-mode-org-mode-html-export)
        - [Emacs list in 15min 따라해봄](#emacs-list-in-15min-)
        - [info 뷰어로 Emacs 이용하기](#info--emacs-)
...
8. [Using org to Blog with Jekyll 해보기](http://orgmode.org/worg/org-tutorials/org-jekyll.html)
9. ~~Jekyll에서 pagination 적용~~
10. ~~Jekyll에서 댓글 시스템 달기~~
  - http://hawksworx.com/blog/adding-a-static-comments-system-to-my-jekyll-build/
11. font 교체하기
  - 좀 예쁜 font가 없나?
12. ~~strikethrough style지원하기 (redcarpet으로 변경해야 함)~~

#### redcarpet으로 markdown 프로세싱 엔진 변경
***
- 2015.2.21
- config를 바꿔주어야 함.
- strikethrough를 나타내려면 설치필요. (  ~~이것이 그리 중요한가?~~ )
...
#### Emacs markdown-toc 기능을 이용해서 목차를 만듬
***
- 2015.2.13
- toc는 만들어주지만 jump는 못하는 듯 -> 숫자가 섞이면 안된다.

#### Emacs dired에서 그림을 바로 보여준다.
***
- 2015.2.13
...
#### org-mode에 plantuml을 이용해서 UML 다이어그램 그리기
***
- 2015.2.11
...
#### Emacs에서 batch mode로 org-mode를 HTML로 export하기
***
- 2015.1.13
- Makefile에 추가완료함. 근데 왜 HTML export명령이 예전 것이 될까?

#### Emacs list in 15min 따라해봄
***
- 2015.1.11
